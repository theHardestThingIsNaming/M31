...
function chapter_1_page_2(){
    ...
    typewriter
        ...
        .pasteString(`<br\><br\><i class="hynes">Hynes:</i> "We don't make it back home."`)
        .pasteString(`<br\><br\>The room waited for more from Hynes, something to explain his statement. When no explanation was coming Commander McKay roused the older man out of this stooper.`)
