...
function chapter_1_page_3() {
  ...
  typewriter
    ...
    .pasteString(
      `<br\><br\><i class="nova">Nova: </i> "System B, is 19 months of travel, and contains a trio of potential planets. Two Class K and one M planet. Due to the distances involved certainty on the planets classification can not be guaranteed, and sits at 78% probability"`
    )
