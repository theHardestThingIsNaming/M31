function startContent() {
    ...
    typewriter
        ...
        .pauseFor(300)
        .typeString(`<br\><br\><i class="nova">Nova:</i> "Commander we have arrived to the target location. The crew and the ship remain fully operational. Primary mission has been derailed due to unexpected parameters" `)
        .start();
}