...
function chapter_1_page_3() {
    ...
    typewriter
        ...
        .pauseFor(3000)
        .pasteString(
            `<br\><br\><i class="mckay">McKay: </i> "Thank you Nova. Doctor Ki, you designed the suspended animation pods. How long can they keep going for if we needed to keep most of the crew in status?"`
        )
        .pasteString(
